...
global/                   횡단: common(ApiResponse·BaseEntity) · config · exception(GlobalExceptionHandler) · observability(Sentry) · security · web(HealthCheck)
